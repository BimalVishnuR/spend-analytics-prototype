    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-shrink-0 p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-gray-900">AI Market Intelligence Assistant</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {isIngesting ? 'Ingesting...' : '📚 Update Knowledge Base'}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex-shrink-0 p-4 border-t border-gray-200">
        {!hasKnowledgeBase && (
          <div className="mb-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <div className="text-sm text-amber-800">
              ⚠️ <strong>No knowledge base found.</strong> Add PDF documents to <code>backend/data/documents/</code> and click "Update Knowledge Base" to enable AI responses.
            </div>
          </div>
        )}
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ask about market trends, competitor analysis..."
